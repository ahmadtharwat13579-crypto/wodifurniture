...
const GH='https://raw.githubusercontent.com/ahmadtharwat13579-crypto/wodi-furniture/main/';
...
function requestLocation(){
  ...
  // Small delay for UX - shows spinner before browser permission dialog
  setTimeout(()=>{
    navigator.geolocation.getCurrentPosition(
      pos=>{
        ...
        res.textContent='تم تحديد موقعك — تكلفة المعاينة والتركيب: '+installCost+' EGP';
      ...
      err=>{
        ...
        if(err.code===1) msg='يرجى السماح للمتصفح بالوصول لموقعك من الإعدادات';
        if(err.code===2) msg='تعذّر تحديد الموقع، حاول مرة أخرى';
        if(err.code===3) msg='انتهى وقت الطلب، حاول مرة أخرى';
        res.textContent=msg+' — أو تواصل معنا واتساب لتحديد التكلفة';
        res.className='loc-result error show';
        btn.disabled=false;
        btn.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3"/></svg> إعادة المحاولة';
      },
